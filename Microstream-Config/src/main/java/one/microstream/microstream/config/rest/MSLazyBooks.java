...
public class MSLazyBooks implements AutoCloseable
{
	private final Client    client;
	private final WebTarget webTarget;

	private static String URL = "http://3.67.234.72:8082/lazybooks/";
	
	public MSLazyBooks()
	{
		this.client    = ClientBuilder.newClient();
		this.webTarget = this.client.target(MSLazyBooks.URL);
	}
